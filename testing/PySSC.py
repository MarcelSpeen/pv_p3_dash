#Created with SAM version 2023.12.17
...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("/Users/marzol/PycharmProjects/pv_p3_dash/testing/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("/Users/marzol/PycharmProjects/pv_p3_dash/testing/ssc.dylib") 
		elif sys.platform == 'linux2':
			self.pdll = CDLL('/Users/marzol/PycharmProjects/pv_p3_dash/testing/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
