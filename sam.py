...
if __name__ == "__main__":
    ssc = PySSC()
    print("Current folder = /Volumes/Samsung_T5/PV/SAM")
    ...
    ssc.data_set_string(
        data,
        b"solar_resource_file",
        b"/Users/marzol/SAM Downloaded Weather Files/24_field_street_worcester_-33.6368_19.4665_nsrdb-msg-v1-0-0-tmy_60_tmy.csv",
    )
    ...
    ssc.data_set_array_from_csv(
        data,
        b"dc_lifetime_losses",
        b"/Volumes/Samsung_T5/PV/SAM/dc_lifetime_losses.csv",
    )
    ssc.data_set_number(data, b"en_ac_lifetime_losses", 0)
    ssc.data_set_array_from_csv(
        data,
        b"ac_lifetime_losses",
        b"/Volumes/Samsung_T5/PV/SAM/ac_lifetime_losses.csv",
    )
    ssc.data_set_number(data, b"save_full_lifetime_variables", 1)
    ssc.data_set_number(data, b"en_snow_model", 0)
    ssc.data_set_number(data, b"system_capacity", 1165.2438)
    ...
    ssc.data_set_number(data, b"inverter_count", 9)
    ...
    ssc.data_set_number(data, b"subarray1_nstrings", 105)
    ...
    ssc.data_set_number(data, b"cec_area", 2.52)
    ssc.data_set_number(data, b"cec_a_ref", 1.82077)
    ssc.data_set_number(data, b"cec_adjust", 4.5835900000000001)
    ssc.data_set_number(data, b"cec_alpha_sc", 0.0049245000000000001)
    ssc.data_set_number(data, b"cec_beta_oc", -0.13126199999999999)
    ssc.data_set_number(data, b"cec_gamma_r", -0.33000000000000002)
    ssc.data_set_number(data, b"cec_i_l_ref", 14.087300000000001)
    ssc.data_set_number(data, b"cec_i_mp_ref", 13.18)
    ssc.data_set_number(data, b"cec_i_o_ref", 1.54051e-11)
    ssc.data_set_number(data, b"cec_i_sc_ref", 14.07)
    ssc.data_set_number(data, b"cec_n_s", 72)
    ssc.data_set_number(data, b"cec_r_s", 0.17208599999999999)
    ssc.data_set_number(data, b"cec_r_sh_ref", 139.55799999999999)
    ssc.data_set_number(data, b"cec_t_noct", 43.899999999999999)
    ssc.data_set_number(data, b"cec_v_mp_ref", 42.100000000000001)
    ssc.data_set_number(data, b"cec_v_oc_ref", 50.100000000000001)
    ...
    ssc.data_set_number(data, b"cec_module_width", 1.2175191748701417)
    ssc.data_set_number(data, b"cec_module_length", 2.0697825972792407)
    ...
    ssc.data_set_number(
        data, b"cec_transient_thermal_model_unit_mass", 11.091900000000001
    )
    ...
    ssc.data_set_number(
        data, b"6par_bifacial_transmission_factor", 0.012999999999999999
    )
    ...
    ssc.data_set_number(
        data, b"6par_transient_thermal_model_unit_mass", 11.091900000000001
    )
    ...
    ssc.data_set_number(
        data, b"snl_transient_thermal_model_unit_mass", 11.091900000000001
    )
    ...
    ssc.data_set_array_from_csv(data, b"load", b"/Volumes/Samsung_T5/PV/SAM/load.csv")
    ssc.data_set_array_from_csv(
        data, b"crit_load", b"/Volumes/Samsung_T5/PV/SAM/crit_load.csv"
    )
    ssc.data_set_array_from_csv(
        data, b"grid_outage", b"/Volumes/Samsung_T5/PV/SAM/grid_outage.csv"
    )
    ...
    ssc.data_set_array_from_csv(
        data, b"adjust_timeindex", b"/Volumes/Samsung_T5/PV/SAM/adjust_timeindex.csv"
    )
    ...
    ssc.data_set_number(data, b"batt_computed_strings", 7494)
    ssc.data_set_number(data, b"batt_computed_series", 139)
    ssc.data_set_number(data, b"batt_computed_bank_capacity", 11999.992320000003)
    ssc.data_set_number(data, b"batt_current_charge_max", 5995.2000000000007)
    ssc.data_set_number(data, b"batt_current_discharge_max", 5995.2000000000007)
    ssc.data_set_number(data, b"batt_power_charge_max_kwdc", 2999.9980800000008)
    ssc.data_set_number(data, b"batt_power_discharge_max_kwdc", 2999.9980800000008)
    ssc.data_set_number(data, b"batt_power_charge_max_kwac", 3124.998000000001)
    ssc.data_set_number(data, b"batt_power_discharge_max_kwac", 2879.9981568000007)
    ...
    ssc.data_set_number(data, b"batt_Qfull_flow", 23980.800000000003)
    ...
    ssc.data_set_number(data, b"LeadAcid_q20_computed", 23980.799999999999)
    ssc.data_set_number(data, b"LeadAcid_q10_computed", 22302.144)
    ssc.data_set_number(data, b"LeadAcid_qn_computed", 14388.48)
    ...
    ssc.data_set_matrix_from_csv(
        data,
        b"batt_lifetime_matrix",
        b"/Volumes/Samsung_T5/PV/SAM/batt_lifetime_matrix.csv",
    )
    ssc.data_set_number(data, b"batt_calendar_choice", 1)
    batt_calendar_lifetime_matrix = [[0, 100], [3650, 80], [7300, 50]]
    ssc.data_set_matrix(
        data, b"batt_calendar_lifetime_matrix", batt_calendar_lifetime_matrix
    )
    ...
    ssc.data_set_array(
        data, b"batt_replacement_schedule_percent", batt_replacement_schedule_percent
    )
    ssc.data_set_number(data, b"batt_mass", 118811.80514851488)
    ssc.data_set_number(data, b"batt_surface_area", 899.99942400000032)
    ssc.data_set_number(data, b"batt_Cp", 1500)
    ssc.data_set_number(data, b"batt_h_to_ambient", 7.5)
    batt_room_temperature_celsius = [25]
    ssc.data_set_array(
        data, b"batt_room_temperature_celsius", batt_room_temperature_celsius
    )
    cap_vs_temp = [
        [0, 80.200000000000003],
        [23, 100],
        [30, 103.09999999999999],
        [45, 105.40000000000001],
    ]
    ...
    ssc.data_set_array(
        data,
        b"dispatch_manual_btm_discharge_to_grid",
    ...
    ssc.data_set_array(
        data, b"dispatch_manual_percent_discharge", dispatch_manual_percent_discharge
    )
    dispatch_manual_percent_gridcharge = [0]
    ssc.data_set_array(
        data, b"dispatch_manual_percent_gridcharge", dispatch_manual_percent_gridcharge
    )
    ...
    ssc.data_set_matrix(
        data, b"dispatch_manual_sched_weekend", dispatch_manual_sched_weekend
    )
    ssc.data_set_number(data, b"dispatch_manual_system_charge_first", 0)
    ssc.data_set_array_from_csv(
        data, b"batt_target_power", b"/Volumes/Samsung_T5/PV/SAM/batt_target_power.csv"
    )
    ...
    ssc.data_set_array_from_csv(
        data,
        b"batt_custom_dispatch",
        b"/Volumes/Samsung_T5/PV/SAM/batt_custom_dispatch.csv",
    )
    ssc.data_set_number(data, b"batt_dispatch_choice", 0)
    ssc.data_set_number(data, b"batt_dispatch_auto_can_fuelcellcharge", 0)
    ssc.data_set_number(data, b"batt_dispatch_auto_can_gridcharge", 1)
    ...
    ssc.data_set_array(
        data, b"batt_load_ac_forecast_escalation", batt_load_ac_forecast_escalation
    )
    ...
    ur_ec_tou_mat = [
        [1, 1, 9.9999999999999998e37, 0, 0.050000000000000003, 0],
        [2, 1, 9.9999999999999998e37, 0, 0.074999999999999997, 0],
        [3, 1, 9.9999999999999998e37, 0, 0.059999999999999998, 0],
        [4, 1, 9.9999999999999998e37, 0, 0.050000000000000003, 0],
    ]
    ...
    ur_dc_tou_mat = [
        [1, 1, 100, 25],
        [1, 2, 9.9999999999999998e37, 35],
        [2, 1, 100, 25],
        [2, 2, 9.9999999999999998e37, 15],
    ]
    ssc.data_set_matrix(data, b"ur_dc_tou_mat", ur_dc_tou_mat)
    ur_dc_flat_mat = [
        [0, 1, 9.9999999999999998e37, 0],
        [1, 1, 9.9999999999999998e37, 0],
        [2, 1, 9.9999999999999998e37, 0],
        [3, 1, 9.9999999999999998e37, 0],
        [4, 1, 9.9999999999999998e37, 0],
        [5, 1, 9.9999999999999998e37, 0],
        [6, 1, 9.9999999999999998e37, 0],
        [7, 1, 9.9999999999999998e37, 0],
        [8, 1, 9.9999999999999998e37, 0],
        [9, 1, 9.9999999999999998e37, 0],
        [10, 1, 9.9999999999999998e37, 0],
        [11, 1, 9.9999999999999998e37, 0],
    ]
    ...
    ssc.data_set_matrix(
        data,
        b"ur_billing_demand_lookback_percentages",
        ur_billing_demand_lookback_percentages,
    )
    ur_dc_billing_demand_periods = [[1, 1], [2, 1]]
    ssc.data_set_matrix(
        data, b"ur_dc_billing_demand_periods", ur_dc_billing_demand_periods
    )
    ...
    ssc.data_set_array_from_csv(
        data, b"grid_curtailment", b"/Volumes/Samsung_T5/PV/SAM/grid_curtailment.csv"
    )
    ...
    ssc.data_set_number(data, b"om_batt_nameplate", 11999.992320000003)
    ...
    itc_fed_percent_maxvalue = [9.9999999999999998e37]
    ...
    itc_sta_percent_maxvalue = [9.9999999999999998e37]
    ...
    ssc.data_set_number(data, b"ibi_fed_percent_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"ibi_sta_percent_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"ibi_uti_percent_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"ibi_oth_percent_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"cbi_fed_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"cbi_sta_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"cbi_uti_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"cbi_oth_maxvalue", 9.9999999999999998e37)
    ...
    ssc.data_set_number(data, b"total_installed_cost", 6323872.9555034889)
    ssc.data_set_number(data, b"salvage_percentage", 0)
    ssc.data_set_number(data, b"batt_salvage_percentage", 0)
    ssc.data_set_number(data, b"battery_total_cost_lcos", 4201825.8963072002)
    ...
    average_battery_roundtrip_efficiency = ssc.data_get_number(
        data, b"average_battery_roundtrip_efficiency"
    )
    print("Battery roundtrip efficiency = ", average_battery_roundtrip_efficiency)
    batt_system_charge_percent = ssc.data_get_number(
        data, b"batt_system_charge_percent"
    )
    ...
    elec_cost_without_system_year1 = ssc.data_get_number(
        data, b"elec_cost_without_system_year1"
    )
    print("Electricity bill without system (year 1) = ", elec_cost_without_system_year1)
    elec_cost_with_system_year1 = ssc.data_get_number(
        data, b"elec_cost_with_system_year1"
    )
